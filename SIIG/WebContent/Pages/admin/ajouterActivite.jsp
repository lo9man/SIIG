				...
				<div id="idcontenu">
					...
					<div id="idcontenudroite1">
						<div id="idcontenudroite2">
							...
							<fieldset>
								<LEGEND align=top>Formulaire pour ajouter une nouvelle
									activité</LEGEND>
								<h:form id="Form">
									<div id="idcontenuformulaire3">
										<table style="width: 700px; border: 0px;">
											<tr>
												...
												<td><h:inputText value="#{activiteController.activite.libelle}"></h:inputText></td>
											</tr>
											<tr><td>  <label >Domaine d'activité : </label></td>
												...
												<td><h:inputText
														value="#{activiteController.activite.coutActivite}"></h:inputText></td>
											</tr>
										</table>
									</div>
									...
									<div style="width: 550px; margin: auto; margin-top: 10px;">
										<h:commandButton styleClass="classbouton" value="Ajouter"
											style="margin-left:200px;" action="#{activiteController.ajouterActivite}"></h:commandButton>
