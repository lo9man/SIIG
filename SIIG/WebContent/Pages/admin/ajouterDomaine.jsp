				...
				<div id="idcontenu">
					...
					<div id="idcontenudroite1">
						<div id="idcontenudroite2">
							...
							<fieldset>
								<LEGEND align=top>Formulaire pour ajouter un nouveau
									domaine d'activité</LEGEND>
								<h:form id="Form">
									<div id="idcontenuformulaire3">
										<table style="width: 700px; border: 0px;">
											<tr>
												<td><label> Libellé domaine : </label>
												</td>
												<td><h:inputText value="#{domaineController.domaine.libelle }" ></h:inputText></td>
											</tr>
										</table>
									</div>
									...
									<div style="width: 550px; margin: auto; margin-top: 10px;">
										<h:commandButton styleClass="classbouton" value="Ajouter"
											style="margin-left:200px;" action="#{domaineController.ajouterDomaine }"></h:commandButton>
