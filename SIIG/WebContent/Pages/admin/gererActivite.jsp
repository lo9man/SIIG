...
<%-- <%@page import="com.sqli.echallenge.carnetvoyage.controllers.*" %>
				...
				<div id="idcontenu">
					...
					<div id="idcontenudroite1">
						<div id="idcontenudroite2">
							...
							<fieldset>
								<LEGEND align=top>La liste des activités</LEGEND>



								<h:dataTable value="#{activiteController.listActivite }" border="1" var="activite"
									...
									<h:column>
										<f:facet name="header">
											<h:outputText>N° activité</h:outputText>
										</f:facet>
										<h:outputText value="#{activite.idActivite }"></h:outputText>
									</h:column>
									...
									<h:column>
										...
										<h:outputText value="#{activite.libelle}"></h:outputText>
									</h:column>
									<h:column>
										<f:facet name="header">
											<h:outputText>Domaine</h:outputText>
										</f:facet>
										<h:outputText value="#{activite.domaine.libelle}"></h:outputText>
									</h:column>
									<h:column>
										<f:facet name="header">
											<h:outputText>Coût (en Dhs)</h:outputText>
										</f:facet>
										<h:outputText value="#{activite.coutActivite}"></h:outputText>
									</h:column>
									...
									<h:column>
										...
										<h:form>
											<h:commandButton image="../../images/modifier.png"
												action="modifierActivite">
												<f:setPropertyActionListener value="#{activite }"
													target="#{activiteController.selectedActivite }" />
											</h:commandButton>
										</h:form>
									</h:column>
									<h:column>
										...
										<h:form>
											<h:commandButton image="../../images/supprimer.png"
												action="#{activiteController.supprimerActivite }"
