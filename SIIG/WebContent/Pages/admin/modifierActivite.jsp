				...
				<div id="idcontenu">
					...
					<div id="idcontenudroite1">
						<div id="idcontenudroite2">
							...
							<fieldset>
								<LEGEND align=top>Modification d'une activité</LEGEND>
								<h:form id="Form">
									<div id="idcontenuformulaire3">
										<table style="width: 700px; border: 0px;">
											<tr>
												<td><label> Libellé activité : </label>
												</td>
												<td><h:inputText value="#{activiteController.selectedActivite.libelle }"></h:inputText></td>
											</tr>
											<tr><td>  <label >Domaine d'activité : </label></td>
	                                                           <td> <h:selectOneMenu value="#{activiteController.selectedItem}">
	                                                           			<f:selectItems value="#{activiteController.selectItemsDomaine}"/>
	                                                           </h:selectOneMenu>
	                                                        </td></tr>
	                                                        <tr>
												<td><label> Coût (en Dhs) : </label>
												</td>
												<td><h:inputText value="#{activiteController.selectedActivite.coutActivite }"></h:inputText></td>
											</tr>
										</table>
									</div>
									...
									<div style="width: 550px; margin: auto; margin-top: 10px;">
										<h:commandButton styleClass="classbouton" value="Enregistrer les modifications"
											style="margin-left:200px;" action="#{activiteController.modifierActivite}"></h:commandButton>
