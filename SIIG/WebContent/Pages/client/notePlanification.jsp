...
<title>Mes activités planifiées</title>
</head>
				...
				<div id="idcontenu">
					...
					<div id="idcontenudroite1">
						<div id="idcontenudroite2">
							...
							<fieldset >
								<LEGEND align=top>Choisir une activité pour rédiger des
									notes mémoires </LEGEND>
								<h:dataTable value="#{sejourController.listePlanification}"
									...
									<h:column>
										<f:facet name="header">
											<h:outputText>Date début</h:outputText>
										</f:facet>
										<h:outputText value="#{planification.id.dateDebutActivite}"></h:outputText>
									</h:column>
									<h:column>
										<f:facet name="header">
											<h:outputText>Heure début</h:outputText>
										</f:facet>
									...
									<h:column>
										<f:facet name="header">
											<h:outputText value="Rédiger/Voir notes"></h:outputText>
										</f:facet>
										<h:form>
